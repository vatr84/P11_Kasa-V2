...
export default function Logo({ color = '#FF6060', width, height, label }) {
    return (
        ...
        >
            ...
            <path d="M92.0322 49.8419V62.4414L97.3731 59.2915V46.6921L92.0322 49.8419Z" />
            <path d="M106.766 34.4632L84.8496 21.6784L72.6944 14.6376L60.7234 35.5749L60.9076 55.2152L82.6396 68L84.8496 66.703V48.1744L94.6106 30.9428L104.556 36.6866V55.2152L106.766 53.9182V34.4632Z" />
        </svg>
    )
}
